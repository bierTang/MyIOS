...
//        }];
    ...
    if (model.avatar.length > 5) {
        [self.headImg sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",[CSCaches shareInstance].webUrl,model.avatar]] placeholderImage:[UIImage imageNamed:@"head_moren"]];
    }else if (model.user_avatar.length > 5) {
        [self.headImg sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",[CSCaches shareInstance].webUrl,model.user_avatar]] placeholderImage:[UIImage imageNamed:@"head_moren"]];
    }
