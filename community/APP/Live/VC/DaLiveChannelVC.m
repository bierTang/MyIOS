...
@interface DaLiveChannelVC () <UICollectionViewDelegate,UICollectionViewDataSource>

@property (nonatomic,strong)UICollectionView *collectionView;

@property (nonatomic,strong)NSArray<DaChannelModel *> *dataArr;


@end

@implementation DaLiveChannelVC
...
-(void)requestData{
    NSLog(@"实际请求地址%@",_name);
    [[AppRequest sharedInstance]requestLiveChannelListDa:_name Block:^(AppRequestState state, id  _Nonnull result) {
        NSLog(@"频道列表");
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell refreshItemDa:self.dataArr[indexPath.item]];
    return cell;
}
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *strUrl = [self.dataArr[indexPath.item].address stringByReplacingOccurrencesOfString:@".txt" withString:@""];
    
        NSString *liveURL0 = [CSCaches shareInstance].anchor_url;
           
            //替换某个字符
        NSString *url = [liveURL0 stringByReplacingOccurrencesOfString:@"/json" withString:[@"/" stringByAppendingString: strUrl]];
