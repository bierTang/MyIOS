...
#import "TollVideoCell.h"


@implementation TollVideoCell
...
- (instancetype)cellInitWith:(UITableView *)tableView Indexpath:(NSIndexPath *)indexPath{
    static NSString *cellId =@"TollVideoCell";
//    self.tableview = tableView;
    TollVideoCell *cell = [tableView dequeueReusableCellWithIdentifier:cellId];
...
-(void)initUI{
    ...
    [bgView makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.top.bottom.equalTo(16);
       }];
