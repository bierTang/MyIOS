...
#import "CMSwitch.h"
#define ZJSwitchMaxHeight 26.0f
#define ZJSwitchMinHeight 26.0f
#define ZJSwitchMinWidth 46.0f
#define ZJSwitchKnobSize 24.0f
...
- (void)layoutSubviews
{
    ...
    if (!self.isOn) {
        ...
        self.knobView.frame = CGRectMake(margin, margin, ZJSwitchKnobSize, ZJSwitchKnobSize);
    } else {
        // frame of on status
        ...
        self.offContentView.frame = CGRectMake(0,  CGRectGetWidth(self.containerView.bounds), CGRectGetWidth(self.containerView.bounds),
                                               CGRectGetHeight(self.containerView.bounds));
        
        self.knobView.frame = CGRectMake(CGRectGetWidth(self.containerView.bounds) - margin - ZJSwitchKnobSize, margin,  ZJSwitchKnobSize,
                                         ZJSwitchKnobSize);
    }
...
- (void)commonInit
{
    ...
    _textFont = [UIFont systemFontOfSize:7.0f];
    ...
    _onContentView.backgroundColor = [UIColor  blueColor];// _onTintColor;
        ...
        case UIGestureRecognizerStateBegan:{
            if (!self.isOn) {
                [UIView animateWithDuration:0.25 animations:^{
                    self.knobView.frame = CGRectMake(margin, margin, ZJSwitchKnobSize + offset, ZJSwitchKnobSize);
