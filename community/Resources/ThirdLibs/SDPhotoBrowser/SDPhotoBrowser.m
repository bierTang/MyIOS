...
//    [self addSubview:saveButton];
    ...
    UILongPressGestureRecognizer *longpress = [[UILongPressGestureRecognizer alloc]initWithTarget:self action:@selector(showsaveImage:)];
    ...
    self.pageControl.frame = CGRectMake((self.bounds.size.width - pageControlSize.width) / 2, self.bounds.size.height * 0.9, pageControlSize.width, pageControlSize.height);
...
- (void)showsaveImage:(UILongPressGestureRecognizer *)tap
{
...
//        saveBtn.frame = CGRectMake(0, 500, SCREEN_WIDTH, 50);
...
//        cancelBtn.frame = CGRectMake(0, 555, SCREEN_WIDTH, 50);
